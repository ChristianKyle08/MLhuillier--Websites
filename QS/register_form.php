...
if (isset($_POST['submit'])) {
   ...
   $cpasswordInput = $_POST['cpassword'];
   $user_type = $_POST['user_type'];

   // ✅ check if user already exists (by email OR id_number)
   ...
   if (mysqli_num_rows($result) > 0) {
       ...
       if ($passwordInput !== $cpasswordInput) {
           ...
           $insert = "INSERT INTO user_form (id_number, first_name, middle_name, last_name, username, password, user_type) 
                      VALUES ('$idNumber', '$fname', '$mname', '$lname', '$email', '$hashedPass', '$user_type')";
