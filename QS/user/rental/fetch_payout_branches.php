...
if (isset($_POST['region'])) {
    ...
    $branchSql = "SELECT DISTINCT payout_branch FROM payout WHERE payout_branch != '' AND region = '$region' ORDER BY payout_branch ASC";
    ...
    if ($resultBranch) {
        ...
        while ($rowBranch = mysqli_fetch_assoc($resultBranch)) {
            echo "<option value='" . htmlspecialchars($rowBranch['payout_branch']) . "'>" . htmlspecialchars($rowBranch['payout_branch']) . "</option>";
        }
    } else {
