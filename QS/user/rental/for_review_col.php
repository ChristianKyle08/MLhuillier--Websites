      ...
      <div class="card shadow border-0 rounded-4">
          ...
          <div class="card-header bg-white border-0 rounded-top-4 px-4 py-3 d-flex justify-content-between align-items-center">
              <h5 class="mb-0 fw-bold text-danger d-flex align-items-center">
                  <i class="bi bi-clock-history me-2"></i> For Review Contracts (DATA ARCHIVING)
              </h5>
                  ...
                  <table class="table table-hover align-middle mb-0">
                      ...
                      <?php
                        ...
                        $query = "
                            ...
                            AND request_status = 'Prepared' AND contract_number != 'VOID'
                        ";
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                            ...
                            echo "<tr>
                                    <td colspan='8' class='text-center text-muted py-5'>
                                        ...
                                        <small class='text-muted'>New transactions will appear here once the created request has been submitted</small>
                                    </td>
                                </tr>";
                        }
                        ?>
