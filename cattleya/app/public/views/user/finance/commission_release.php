...
<div class="clr-layout-wrapper">
    <main class="clr-main-content">
        ...
        <?php if (!empty($grouped_rfps)): ?>
            ...
            <form id="multiRfpForm" method="POST" action="/user/finance/rfp-approval-flow">
                <?php 
                $stage_groups = [
                    'encoder'  => [],
                    'auditor'  => [],
            ...
            <?php foreach ($grouped_rfps as $grfp): ?>
                <form id="rfp_load_group_<?= (int)$grfp['rfp_id'] ?>" method="POST" action="/user/finance/rfp-approval-flow" style="display:none;">
        ...
        <div class="clr-table-card">
            <form method="POST" action="/user/finance/rfp-approval-flow" id="commissionForm">
...
?>
            <form id="rfp_load_<?= $cid ?>_<?= strtotime($date) ?>_<?= $r ?>" method="POST" action="/user/finance/rfp-approval-flow">
