...
<div class="clr-layout-wrapper">
    <main class="clr-main-content">
        ...
        <?php if (!empty($grouped_rfps)): ?>
            ...
            <form id="multiRfpForm" method="POST" action="/user/auditor/rfp-approval-flow">
                <?php 
                $stage_groups = [
                    'encoder'  => [],
                    'auditor'  => [],
            ...
            <?php foreach ($grouped_rfps as $grfp): ?>
                <form id="rfp_load_group_<?= (int)$grfp['rfp_id'] ?>" method="POST" action="/user/auditor/rfp-approval-flow" style="display:none;">
