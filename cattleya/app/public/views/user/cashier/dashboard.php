...
<div class="container-fluid py-4 px-3 px-md-4">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-8">
            <h3 class="fw-800 text-dark mb-1" style="letter-spacing: -0.02em;">Cashier Overview Dashboard</h3>
            <p class="text-muted mb-0 small">Real-time system transaction logs, payment metrics, and service records.</p>
        </div>
